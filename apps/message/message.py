...
class Run():
    def __init__(self, fona):
        ...
        #Load images
        self.keyboard_image = pygame.image.load(APP_PATH + 'message/keyboard.png')
        self.num_keyboard_image = pygame.image.load(APP_PATH + 'message/numbered_keyboard.png')
        self.bubble = pygame.image.load(APP_PATH + 'message/bubble.png')
        self.keyboard_rect = self.keyboard_image.get_rect()
        self.keyboard_rect.x = 6
        self.keyboard_rect.y = 293

        #Main conversation image
        self.conversation_image = pygame.image.load(APP_PATH + 'message/conversation.png')
        ...
        self.message_font = pygame.font.Font(ROOT_DIR + 'fonts/arial.ttf', 12)
