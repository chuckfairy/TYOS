...
class Run():
    def __init__(self, fona):
        ...
        #Load images
        self.circle_image = pygame.image.load(APP_PATH + 'call/circle.png')
        self.call_image = pygame.image.load(APP_PATH + 'call/call.png')
        self.back_image = pygame.image.load(APP_PATH + 'call/back.png')
        self.hangup_image = pygame.image.load(APP_PATH + 'call/hangup.png')
        ...
        #Setup fonts
        self.font = pygame.font.Font(ROOT_DIR + 'fonts/arial.ttf', 48)
